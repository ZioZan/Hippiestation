...
/datum/design/cyberimp_surgical
    ...
    build_type = PROTOLATHE | MECHFAB
    materials = list (MAT_METAL = 2500, MAT_GLASS = 1500, MAT_SILVER = 500)
...
/datum/design/cyberimp_nutriment
	...
	build_type = PROTOLATHE | MECHFAB
	construction_time = 40
	materials = list(MAT_METAL = 500, MAT_GLASS = 500, MAT_SILVER = 750)
...
/datum/design/cyberimp_surgery
	...
	desc = "A set of surgical tools hidden behind a concealed panel on the user's arm"
	id = "ci-thrusters"
	req_tech = list("materials" = 6, "biotech" = 5, "magnets" = 5, "engineering" = 5)
	build_type = PROTOLATHE | MECHFAB
	construction_time = 80
	materials = list(MAT_METAL = 4000, MAT_GLASS = 2000, MAT_SILVER = 1000, MAT_DIAMOND = 1000)
	build_path = /obj/item/organ/cyberimp/arm/surgery
...
/datum/design/autosurgeon
	...
	id = "autosurgeon"
	req_tech = list("materials" = 7, "biotech" = 6, "magnets" = 6, "engineering" = 6, "combat" = 6, "powerstorage" = 6, "bluespace" = 6, "programming"=6, "syndicate" = 4)
	build_type = PROTOLATHE | MECHFAB
...
/datum/design/implant_comstimms
	...
	req_tech = list("biotech" = 6, "combat" = 6, "syndicate" = 4)
	build_type = PROTOLATHE
